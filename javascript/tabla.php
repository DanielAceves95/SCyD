<?php
 ...
 $cols = array('id', 'nombre','fecha','Acciones'=>'<button class="borrar" data="@[0]">img src="https://cdn4.iconfinder.com/data/icons/gnome-desktop-icons-png/PNG/32/Gnome-Process-Stop-32.png"</button>');
